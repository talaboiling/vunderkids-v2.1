...
const SubscriptionDetails = () => {
  ...
  return (
    <div className="contain" style={{backgroundColor:"#ccd6eb", height:"100vh"}}>
        ...
        <div className="subscriptionBanners" style={{marginTop:"40px"}}>
            <div className="certbanner" style={{width:"500px"}}>
                <p className="defaultStyle" style={{fontSize:"xx-large", fontWeight:"800", color:"white", textAlign:"center", textWrap:"wrap", zIndex:"-1"}}>
                    {t('premiumPlans')}
                </p>
            </div>
