                        ...
                        <form className='inputField' onSubmit={handleSubmit}>
                            <span className="gendemail">
                                <span>
                                    ...
                                    <input type="email" id="email" name="email" placeholder='maksat01@example.com' value={formData.email} onChange={handleInputChange} required style={{ minWidth: "350px" }} />
                                </span>
                            </span>
                            <label htmlFor="password">Ваш пароль:</label><br />
                            <input type="password" id="password" name="password" placeholder='********' value={formData.password} onChange={handleInputChange} required style={{ maxWidth: "350px" }} /><br />
