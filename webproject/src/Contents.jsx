        ...
        <>
            <div className="contents" id='oplatforme'>
                ...
                <div className="contRight">
                    <img src={icon_stars} className='star-icon' alt=""/>
                    ...
                    <div style={{display:"flex", justifyContent:"space-between", alignItems:"center"}}>
                        <img src={icon_stars} alt="" className='star-icon2'/>
                    ...
                    <img src={icon_stars} className='star-icon3' alt=""/>
                </div>
            </div>
            <div className="hookUnder">
                <div className="hookInfo">
                    ...
                    <div className="hookInfoRight">
                        ...
                        <p style={{marginLeft:"10px"}}>{t ('students100k')}</p>
                        <img src={icon_school} alt="icon_school" className='glowImg'/>
                        <p style={{marginLeft:"10px"}}>{t ('schools5k')}</p>
                    </div>
                </div>
            </div>
